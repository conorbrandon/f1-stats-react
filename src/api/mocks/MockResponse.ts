...
export const MockScheduleResponse: ErgastRaceResponse = {
  "MRData": {
    "xmlns": "http://ergast.com/mrd/1.5",
    "series": "f1",
...
export const MockScheduleResponse2022: ErgastRaceResponse = {
  "MRData": {
    "xmlns": "http://ergast.com/mrd/1.5",
    "series": "f1",
...
export const EmptyScheduleResponse: ErgastRaceResponse = { MRData: { RaceTable: { Races: [], season: '' } } };

export const MockResultsResponse: ErgastRaceResponse = {
  "MRData": {
    "xmlns": "http://ergast.com/mrd/1.5",
    "series": "f1",
...
export const MockSprintResponse: ErgastRaceResponse = {
  "MRData": {
      "xmlns": "http://ergast.com/mrd/1.5",
      "series": "f1",
...
export const MockCurrentLastResultResponse: ErgastRaceResponse = {
  "MRData": {
      "xmlns": "http://ergast.com/mrd/1.5",
      "series": "f1",
...
export const MockQualifyingResponse2022: ErgastRaceResponse = {
  "MRData": {
    "xmlns": "http://ergast.com/mrd/1.5",
    "series": "f1",
    "url": "http://ergast.com/api/f1/current/5/qualifying.json",
    "limit": "1000",
    "offset": "0",
    "total": "20",
    "RaceTable": {
...
export const MockQualifyingResponse: ErgastRaceResponse = {
  "MRData": {
    "xmlns": "http://ergast.com/mrd/1.5",
    "series": "f1",
    "url": "http://ergast.com/api/f1/2008/5/qualifying.json",
    "limit": "30",
    "offset": "0",
    "total": "20",
    "RaceTable": {
...
export const MockDriverResponse: ErgastDriverResponse = {
  "MRData": {
    "xmlns": "http://ergast.com/mrd/1.5",
    "series": "f1",
    "url": "http://ergast.com/api/f1/drivers/massa.json",
    "limit": "30",
    "offset": "0",
    "total": "1",
    "DriverTable": {
...
export const MockLastRace: ErgastRaceResponse = {
  "MRData": {
      "xmlns": "http://ergast.com/mrd/1.5",
      "series": "f1",
...
export const MockRace: ErgastRaceResponse ={
  "MRData": {
      "xmlns": "http://ergast.com/mrd/1.5",
      "series": "f1",
      "url": "http://ergast.com/api/f1/2008/5.json",
      "limit": "30",
      "offset": "0",
      "total": "1",
      "RaceTable": {
...
export const MockRace2022: ErgastRaceResponse = {
  "MRData": {
      "xmlns": "http://ergast.com/mrd/1.5",
      "series": "f1",
      "url": "http://ergast.com/api/f1/current/5.json",
      "limit": "30",
      "offset": "0",
      "total": "1",
      "RaceTable": {
